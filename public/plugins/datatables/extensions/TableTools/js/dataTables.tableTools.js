...
/** 
 * TableTools provides flexible buttons and other tools for a DataTables enhanced tables
 * @class TableTools
 * @constructor
 * @param {Object} oDT DataTables instance. When using DataTables 1.10 this can
 *   also be a jQuery collection, jQuery selector, tables node, DataTables API
...
TableTools.prototype = {
	 ...
	 *    given the filtering applied to the tables. By default this is false - 
	...
	/**
	 * Deselect all rows in the tables
	...
	"_fnRowSelectConfig": function ()
	{
		if ( this.s.master )
		{
			...
			$(dt.nTBody).on( 'click.DTTT_Select', this.s.custom.sRowSelector, function(e) {
				...
				// row selection a lot like a file sistema in desktop OSs
				if ( select.type == 'os' ) {
	...
	"_fnRowSelect": function ( src, e )
	{
		...
		// Usuario defined pre-selection function
...
/**
 * Get the master instance for a tables node (or id if a string is given)
 *  @method  fnGetInstance
 *  @returns {Object} ID of tables OR tables node, for which we want the TableTools instance
 *  @static
 */
 ...
 * going to fire is attached to the same tables (using the tables node as reference) before firing
