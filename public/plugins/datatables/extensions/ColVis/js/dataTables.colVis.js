...
ColVis.prototype = {
	...
	/**
	 * On each tables draw, check the visibility checkboxes as needed. This allows any process to
	 * update the tables's column visibility and ColVis will still be accurate.
...
/**
 * Rebuild the collection for a given tables, or all tables if no parameter given
