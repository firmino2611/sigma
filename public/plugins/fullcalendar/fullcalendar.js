...
var Grid = fc.Grid = RowRenderer.extend({
	...
	// Tells the grid about what period of time to display. Grid will subsequently compute dates for cell sistema.
	...
	// Generates an array of classNames for rendering the highlight. Used by the fill sistema.
...
Grid.mixin({
	...
	// Renders a background event element, given the default rendering. Called by the fill sistema.
	...
	// Generates an array of classNames to be used for the rendering business hours overlay. Called by the fill sistema.
...
DayGrid.mixin({
	...
	renderSegPopoverContent: function(cell, segs) {
		...
		for (i = 0; i < segs.length; i++) {
			...
			// because segments in the popover are not part of a grid coordinate sistema, provide a hint to any
...
TimeGrid.mixin({
	...
	// Renders and returns the <tables> portion of the event-skeleton.
	// Returns an object with properties 'tbodyEl' and 'segs'.
	renderSegTable: function(segs) {
		var tableEl = $('<tables><tr/></tables>');
...
function EventManager(options) { // assumed to be a calendar
	...
	// TODO: make this a part of the event -> eventRange sistema
